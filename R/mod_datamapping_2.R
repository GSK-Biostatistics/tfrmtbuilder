...
#'
#' @noRd
datamapping_2_server <- function(id, data, tfrmt_orig, mode){
  ...
  moduleServer(
    ...
    function(input, output, session){
      ...
      settings_out <- eventReactive(req(initial_valid()==TRUE || input$save),{
